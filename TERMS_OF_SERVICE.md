...
- View and explore routes from other users
...
- Contains explicit, violent, or inappropriate material
...
- Not attempt to hack, disrupt, or compromise the Service
- Not use automated systems (bots) to interact with the Service
...
### 6.1 GPS Data
- Photos you upload may contain GPS location data
- This data is used to generate route maps
- Routes are public by default and can be viewed by all users
- You can delete your routes at any time

### 6.2 Personal Information
- We collect and store email addresses and names
- We use Supabase for authentication and data storage
- We do not sell your personal information to third parties
- See our Privacy Policy for more details

## 7. Interactions and Social Features

### 7.1 Likes and Comments
- Users can like and comment on public routes
- Comments must be respectful and follow our content guidelines
- We reserve the right to remove inappropriate comments
- You can delete your own comments at any time

### 7.2 User Profiles
- Profiles are public and can be viewed by all users
- Your profile shows your username, routes, and statistics
- You can view other users' profiles and routes
...
- We use OpenStreetMap for map tiles (© OpenStreetMap contributors)
- We use OSRM for route generation
...
- Non-infringement
- Accuracy of GPS data or route information

We do not guarantee that:
- The Service will be uninterrupted or error-free
- Defects will be corrected
- The Service is free of viruses or harmful components
- Route information is accurate or up-to-date
...
- Our total liability shall not exceed $100 USD or the amount you paid to use the Service (whichever is less)
...
- Deleting your account will remove your routes and data
...
- We will notify users of material changes via email or the Service
- Continued use of the Service after changes constitutes acceptance
- If you do not agree to changes, you should stop using the Service
...
- No guarantee is made that the Service will continue indefinitely
...
- Access may not be legal in certain countries
